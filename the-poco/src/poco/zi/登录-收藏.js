...
import {Drawer, Button, Input, Modal, Space, Layout} from 'antd';

import {StarFilled,LeftOutlined, EyeInvisibleOutlined, EyeTwoTone ,
...
const DL1 = () => {
  ...
  return (
    <>
    <ConfigProvider autoInsertSpaceInButton={false}  style={{background:'#fff'}}>
    <div >
      <Button onClick={showDrawer} className={{border:'0'}} type="text"> {/*disabled */}
        <span className='p13-footer'>
        <StarFilled className='p13-icon'/>
        </span>
        <bdo class="p13-footerz">收藏</bdo>
      </Button>
    </div>
